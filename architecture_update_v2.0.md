...
| **Subroutine support** | None | **CALL/RET** with 16-entry return stack |
| **Data memory** | Stack only | Stack + **256×16 Data RAM** (LOAD/STORE) |
| **Module count** | 9 source modules | **11 source modules** (+2 new) |
...
| **Stack depth** | Fixed 16 | **Parameterised** (default 16, configurable) |
...
Depth:       16 entries (parameterised)
