## ============================================================================
## Basys 3 Constraint File for Stack CPU (cpu_top)
## Target FPGA: xc7a35ticpg236-1L (Artix-7)
##
## Pin assignments for:
##   - 100 MHz Clock
##   - Reset button (center)
...
## Decimal point (Active-low, active = on)
## Directly tie high (off) since not used by this design
...
## SPI configuration mode for QSPI boot
